...
deny contains result if {
	...
	result := utils.result_helper_with_term(rego.metadata.chain(), [key, _allowed_rpm_signature_keys], key)
}
...
_allowed_rpm_signature_keys := utils.rule_data("allowed_rpm_signature_keys")

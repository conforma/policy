...
# Test complex format rule-based trust
testis_trusted_task_complex_allowed if {
	allowed_task := {
		"name": "build",
		"ref": {
	...
	is_trusted_task(allowed_task) with data.trusted_task_rules as {
		"allow": [
			{
				"task_refs": ["oci://quay.io/konflux-ci/tekton-catalog/task-buildah:*"],
...
testis_trusted_task_complex_denied if {
	denied_task := {
		"name": "build",
		"ref": {
	...
	not is_trusted_task(denied_task) with data.trusted_task_rules as {
		...
		"deny": [
			{
				"task_refs": ["oci://quay.io/konflux-ci/tekton-catalog/task-buildah:0.3"],
				"effective_on": "2024-01-01T00:00:00Z",
			},
		],
	}
...
testis_trusted_task_complex_future_effective if {
	future_task := {
		"name": "build",
		"ref": {
...
testis_trusted_task_complex_signing_required if {
	signed_task := {
		"name": "build",
		"ref": {
...
testis_trusted_task_complex_version_constraints if {
	versioned_task := {
		"name": "build",
		"ref": {

...
* To exclude this rule, add `schedule.date_restriction` to the `exclude` list in your policy config. You can also exclude the entire package with `schedule`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `schedule.rule_data_provided` to the `exclude` list in your policy config. You can also exclude the entire package with `schedule`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `schedule.weekday_restriction` to the `exclude` list in your policy config. You can also exclude the entire package with `schedule`, or exclude by collection with `@collection-name`.

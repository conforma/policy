...
* To exclude this rule, add `external_parameters.pipeline_run_params` to the `exclude` list in your policy config. You can also exclude the entire package with `external_parameters`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `external_parameters.pipeline_run_params_provided` to the `exclude` list in your policy config. You can also exclude the entire package with `external_parameters`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `external_parameters.restrict_shared_volumes` to the `exclude` list in your policy config. You can also exclude the entire package with `external_parameters`, or exclude by collection with `@collection-name`.

...
* To exclude this rule, add `github_certificate.gh_workflow_extensions` to the `exclude` list in your policy config. You can also exclude the entire package with `github_certificate`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `github_certificate.gh_workflow_name` to the `exclude` list in your policy config. You can also exclude the entire package with `github_certificate`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `github_certificate.gh_workflow_repository` to the `exclude` list in your policy config. You can also exclude the entire package with `github_certificate`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `github_certificate.gh_workflow_ref` to the `exclude` list in your policy config. You can also exclude the entire package with `github_certificate`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `github_certificate.gh_workflow_trigger` to the `exclude` list in your policy config. You can also exclude the entire package with `github_certificate`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `github_certificate.rule_data_provided` to the `exclude` list in your policy config. You can also exclude the entire package with `github_certificate`, or exclude by collection with `@collection-name`.

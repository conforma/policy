...
* To exclude this rule, add `kind.kind_present` to the `exclude` list in your policy config. You can also exclude the entire package with `kind`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `kind.expected_kind` to the `exclude` list in your policy config. You can also exclude the entire package with `kind`, or exclude by collection with `@collection-name`.

...
* To exclude this rule, add `maven_repos.deny_unpermitted_urls` to the `exclude` list in your policy config. You can also exclude the entire package with `maven_repos`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `maven_repos.policy_data_missing` to the `exclude` list in your policy config. You can also exclude the entire package with `maven_repos`, or exclude by collection with `@collection-name`.

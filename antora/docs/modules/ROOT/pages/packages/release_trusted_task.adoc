...
* To exclude this rule, add `trusted_task.data_format` to the `exclude` list in your policy config. You can also exclude the entire package with `trusted_task`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `trusted_task.future_deny_rule` to the `exclude` list in your policy config. You can also exclude the entire package with `trusted_task`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `trusted_task.pinned` to the `exclude` list in your policy config. You can also exclude the entire package with `trusted_task`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `trusted_task.tagged` to the `exclude` list in your policy config. You can also exclude the entire package with `trusted_task`, or exclude by collection with `@collection-name`.
* Effective from: `2024-05-07T00:00:00Z`
...
* To exclude this rule, add `trusted_task.data` to the `exclude` list in your policy config. You can also exclude the entire package with `trusted_task`, or exclude by collection with `@collection-name`.
* Effective from: `2024-05-07T00:00:00Z`
...
* To exclude this rule, add `trusted_task.trusted` to the `exclude` list in your policy config. You can also exclude the entire package with `trusted_task`, or exclude by collection with `@collection-name`.
* Effective from: `2024-05-07T00:00:00Z`
...
* To exclude this rule, add `trusted_task.current` to the `exclude` list in your policy config. You can also exclude the entire package with `trusted_task`, or exclude by collection with `@collection-name`.
* Effective from: `2024-05-07T00:00:00Z`
...
* To exclude this rule, add `trusted_task.valid_trusted_artifact_inputs` to the `exclude` list in your policy config. You can also exclude the entire package with `trusted_task`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `trusted_task.trusted_parameters` to the `exclude` list in your policy config. You can also exclude the entire package with `trusted_task`, or exclude by collection with `@collection-name`.

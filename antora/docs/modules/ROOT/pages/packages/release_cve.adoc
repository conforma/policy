...
* To exclude this rule, add `cve.cve_blockers` to the `exclude` list in your policy config. You can also exclude the entire package with `cve`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `cve.unpatched_cve_blockers` to the `exclude` list in your policy config. You can also exclude the entire package with `cve`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `cve.cve_results_found` to the `exclude` list in your policy config. You can also exclude the entire package with `cve`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `cve.cve_warnings` to the `exclude` list in your policy config. You can also exclude the entire package with `cve`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `cve.unpatched_cve_warnings` to the `exclude` list in your policy config. You can also exclude the entire package with `cve`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `cve.rule_data_provided` to the `exclude` list in your policy config. You can also exclude the entire package with `cve`, or exclude by collection with `@collection-name`.

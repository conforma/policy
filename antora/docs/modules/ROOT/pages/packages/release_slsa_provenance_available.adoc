...
* To exclude this rule, add `slsa_provenance_available.allowed_predicate_types_provided` to the `exclude` list in your policy config. You can also exclude the entire package with `slsa_provenance_available`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `slsa_provenance_available.attestation_predicate_type_accepted` to the `exclude` list in your policy config. You can also exclude the entire package with `slsa_provenance_available`, or exclude by collection with `@collection-name`.

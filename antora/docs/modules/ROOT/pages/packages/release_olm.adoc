...
* To exclude this rule, add `olm.csv_semver_format` to the `exclude` list in your policy config. You can also exclude the entire package with `olm`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `olm.feature_annotations_format` to the `exclude` list in your policy config. You can also exclude the entire package with `olm`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `olm.allowed_registries` to the `exclude` list in your policy config. You can also exclude the entire package with `olm`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `olm.required_network_policy_rbac_for_operands` to the `exclude` list in your policy config. You can also exclude the entire package with `olm`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `olm.allowed_resource_kinds` to the `exclude` list in your policy config. You can also exclude the entire package with `olm`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `olm.olm_bundle_multi_arch` to the `exclude` list in your policy config. You can also exclude the entire package with `olm`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `olm.allowed_registries_related` to the `exclude` list in your policy config. You can also exclude the entire package with `olm`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `olm.required_olm_features_annotations_provided` to the `exclude` list in your policy config. You can also exclude the entire package with `olm`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `olm.subscriptions_annotation_format` to the `exclude` list in your policy config. You can also exclude the entire package with `olm`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `olm.inaccessible_related_images` to the `exclude` list in your policy config. You can also exclude the entire package with `olm`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `olm.unmapped_references` to the `exclude` list in your policy config. You can also exclude the entire package with `olm`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `olm.unpinned_references` to the `exclude` list in your policy config. You can also exclude the entire package with `olm`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `olm.unpinned_snapshot_references` to the `exclude` list in your policy config. You can also exclude the entire package with `olm`, or exclude by collection with `@collection-name`.
* Effective from: `2024-08-15T00:00:00Z`
...
* To exclude this rule, add `olm.unpinned_related_images` to the `exclude` list in your policy config. You can also exclude the entire package with `olm`, or exclude by collection with `@collection-name`.

...
* To exclude this rule, add `tasks.required_untrusted_task_found` to the `exclude` list in your policy config. You can also exclude the entire package with `tasks`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `tasks.required_tasks_found` to the `exclude` list in your policy config. You can also exclude the entire package with `tasks`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `tasks.data_provided` to the `exclude` list in your policy config. You can also exclude the entire package with `tasks`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `tasks.future_required_tasks_found` to the `exclude` list in your policy config. You can also exclude the entire package with `tasks`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `tasks.pinned_task_refs` to the `exclude` list in your policy config. You can also exclude the entire package with `tasks`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `tasks.pipeline_has_tasks` to the `exclude` list in your policy config. You can also exclude the entire package with `tasks`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `tasks.pipeline_required_tasks_list_provided` to the `exclude` list in your policy config. You can also exclude the entire package with `tasks`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `tasks.required_tasks_list_provided` to the `exclude` list in your policy config. You can also exclude the entire package with `tasks`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `tasks.successful_pipeline_tasks` to the `exclude` list in your policy config. You can also exclude the entire package with `tasks`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `tasks.unsupported` to the `exclude` list in your policy config. You can also exclude the entire package with `tasks`, or exclude by collection with `@collection-name`.

...
* To exclude this rule, add `provenance_materials.git_clone_source_matches_provenance` to the `exclude` list in your policy config. You can also exclude the entire package with `provenance_materials`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `provenance_materials.git_clone_task_found` to the `exclude` list in your policy config. You can also exclude the entire package with `provenance_materials`, or exclude by collection with `@collection-name`.

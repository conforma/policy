...
* To exclude this rule, add `rhtap_multi_ci.attestation_format` to the `exclude` list in your policy config. You can also exclude the entire package with `rhtap_multi_ci`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `rhtap_multi_ci.attestation_found` to the `exclude` list in your policy config. You can also exclude the entire package with `rhtap_multi_ci`, or exclude by collection with `@collection-name`.

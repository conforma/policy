...
* To exclude this rule, add `slsa_build_scripted_build.build_script_used` to the `exclude` list in your policy config. You can also exclude the entire package with `slsa_build_scripted_build`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `slsa_build_scripted_build.build_task_image_results_found` to the `exclude` list in your policy config. You can also exclude the entire package with `slsa_build_scripted_build`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `slsa_build_scripted_build.image_built_by_trusted_task` to the `exclude` list in your policy config. You can also exclude the entire package with `slsa_build_scripted_build`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `slsa_build_scripted_build.subject_build_task_matches` to the `exclude` list in your policy config. You can also exclude the entire package with `slsa_build_scripted_build`, or exclude by collection with `@collection-name`.

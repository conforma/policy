...
* To exclude this rule, add `rpm_signature.allowed` to the `exclude` list in your policy config. You can also exclude the entire package with `rpm_signature`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `rpm_signature.result_format` to the `exclude` list in your policy config. You can also exclude the entire package with `rpm_signature`, or exclude by collection with `@collection-name`.
* Effective from: `2024-10-05T00:00:00Z`
...
* To exclude this rule, add `rpm_signature.rule_data_provided` to the `exclude` list in your policy config. You can also exclude the entire package with `rpm_signature`, or exclude by collection with `@collection-name`.
* Effective from: `2024-10-05T00:00:00Z`

...
* To exclude this rule, add `volatile_config.expiring_rule` to the `exclude` list in your policy config. You can also exclude the entire package with `volatile_config`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `volatile_config.expired_rule` to the `exclude` list in your policy config. You can also exclude the entire package with `volatile_config`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `volatile_config.invalid_config` to the `exclude` list in your policy config. You can also exclude the entire package with `volatile_config`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `volatile_config.no_expiration` to the `exclude` list in your policy config. You can also exclude the entire package with `volatile_config`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `volatile_config.pending_rule` to the `exclude` list in your policy config. You can also exclude the entire package with `volatile_config`, or exclude by collection with `@collection-name`.

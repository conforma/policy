...
* To exclude this rule, add `slsa_build_build_service.allowed_builder_ids_provided` to the `exclude` list in your policy config. You can also exclude the entire package with `slsa_build_build_service`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `slsa_build_build_service.slsa_builder_id_found` to the `exclude` list in your policy config. You can also exclude the entire package with `slsa_build_build_service`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `slsa_build_build_service.slsa_builder_id_accepted` to the `exclude` list in your policy config. You can also exclude the entire package with `slsa_build_build_service`, or exclude by collection with `@collection-name`.

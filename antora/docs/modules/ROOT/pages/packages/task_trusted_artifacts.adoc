...
* To exclude this rule, add `trusted_artifacts.parameter` to the `exclude` list in your policy config. You can also exclude the entire package with `trusted_artifacts`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `trusted_artifacts.result` to the `exclude` list in your policy config. You can also exclude the entire package with `trusted_artifacts`, or exclude by collection with `@collection-name`.
...
* To exclude this rule, add `trusted_artifacts.workspace` to the `exclude` list in your policy config. You can also exclude the entire package with `trusted_artifacts`, or exclude by collection with `@collection-name`.

...
* xref:packages/release_rpm_repo_verification.adoc#rpm_repo_verification__rule_data_provided[RPM Repository Verification: Rule data provided]        
...
* xref:packages/release_rpm_repos.adoc#rpm_repos__rule_data_provided[RPM Repos: Known repo id list provided]        
* xref:packages/release_rpm_repo_verification.adoc#rpm_repo_verification__allowed_gpg_key[RPM Repository Verification: Allowed GPG key]        
* xref:packages/release_rpm_repo_verification.adoc#rpm_repo_verification__gpg_signature_verified[RPM Repository Verification: GPG signature verified]        
* xref:packages/release_rpm_repo_verification.adoc#rpm_repo_verification__metadata_checksums_verified[RPM Repository Verification: Metadata checksums verified]        
* xref:packages/release_rpm_repo_verification.adoc#rpm_repo_verification__result_format[RPM Repository Verification: Result format]        
* xref:packages/release_rpm_repo_verification.adoc#rpm_repo_verification__rule_data_provided[RPM Repository Verification: Rule data provided]        
...
| xref:packages/release_rpm_repo_verification.adoc[rpm_repo_verification]
a| This package provides rules for verifying yum repository-level GPG signatures and checksum chains as reported in the SLSA Provenance attestation. This is an alternative to individual RPM signature verification for packages distributed via GPG-signed yum repositories.
